...
public class AssetTest extends TestCase {
	...
	private Asset asset1SnapShot;
	private Asset asset13SnapShot;
	...
	protected void setUp() throws Exception {
		...
		asset1SnapShot = new Asset();
		asset1SnapShot.setAssetID(STD_ASSET_ID);
		asset1SnapShot.setGroupID(Constants.FAC_STAFF_GROUPID);
		asset1SnapShot.setState(Constants.RETIRED);
		
		asset13SnapShot = new Asset();
		asset13SnapShot.setAssetID(13);
		asset13SnapShot.setGroupID(32956);
		asset13SnapShot.setState(Constants.CHECKED_OUT);
		asset13SnapShot.setCheckOutDateTime(FORMAT.parseDateTime("2016-02-09 14:43:41"));
		asset13SnapShot.setCheckInDateTime(FORMAT.parseDateTime("2016-02-09 19:43:41"));
	}
	...
	public void testSetAssetValuesFromAPIResponse() throws JsonParseException, IOException{
		emptyAsset.setAssetValuesFromAPIResponseForID(RestrictCheckInTestMockVals.EXPECTED_JSON_FOR_ASSET_1, 1);
		Assert.assertTrue(emptyAsset.equals(asset1SnapShot));
		availableAsset.setAssetValuesFromAPIResponseForID(RestrictCheckInTestMockVals.EXPECTED_JSON_FOR_ASSET_13, 13);
		Assert.assertTrue(availableAsset.equals(asset13SnapShot));
		emptyAsset.setAssetValuesFromAPIResponseForID(RestrictCheckInTestMockVals.EXPECTED_JSON_FOR_ASSET_13, 13);
		Assert.assertTrue(emptyAsset.equals(asset13SnapShot));
	}
